...
arr=['اصفهان' ,'آران و بيدگل','اردستان','باغ بهادران','تيران','چادگان','خميني شهر','خوانسار','دولت آباد','دهاقان','زرين شهر','زیبا شهر','سميرم','سپاهان شهر','شاهين شهر','شهرضا','فريدن','فريدون شهر','فلاورجان','فولاد شهر','قهدریجان','كاشان','گلدشت','گلپايگان','مباركه','ملک شهر','نايين','نجف آباد','نطنز','هرند'];
...
arr=['تهران','اندیشه','اسلام شهر','بومهن','پاكدشت','تجريش','چهاردانگه','دماوند','رباط كريم','رودهن','ري','شريف آباد','شهريار','فشم','فيروزكوه','قدس','قرچك','كن','كهريزك','گلستان','لواسان','ملارد','ورامين'];
...
arr=['مشهد','بردسكن','بجستان','تايباد','تربت جام','تربت حيدريه','جغتای','جوین','چناران','خواف','خلیل آباد','درگز','رشتخوار','سبزوار','سرخس','طوس','طرقبه','فريمان','قوچان','كاشمر','كلات','گناباد','نيشابور'];
...
if(arr.length>0){$('.shahr').find('select').append($('<option>', {
    text: 'انتخاب شهر'
}));
